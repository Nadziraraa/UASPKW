...
<body>
                   ...
                   <form method="post" action="create.php" name="form">
                        <div class="modal-header">
                            ...
                            <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="no_ktp" placeholder="Masukkan NO KTP Karyawan" name="no_ktp" required>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="no_tlp" placeholder="Masukkan Nomor telpon Karyawan" name="no_tlp" required>
                                </div>
                                <div class="mb-3">
                                    <label for="thn_msk" class="form-label">Tahun Masuk</label>
                                    <textarea type="text" class="form-control" id="thn_msk" placeholder="Masukkan Tahun Masuk Karyawan" name="thn_msk" required></textarea>
                                </div>
                                <div class="mb-3">
                                    <label for="jml_masa_krj" class="form-label">Jumlah Masa Kerja</label>
                                    <input type="text" class="form-control" id="jml_masa_krj" placeholder="Masukkan masa Kerja Kayawan" name="jml_masa_krj" required>
                                </div>
                            </div>
    ...
    <div class="container mt-5">
      ...
      <tbody>
          ...
          include 'koneksi.php';
          $no = 1;
          $login_gc = mysqli_query($koneksi, "select * from karyawan");
          while ($data = mysqli_fetch_array($login_gc)){
            ?>
              <tr>
                  <td><?php echo $no++; ?> </td>
                  ...
                  <td><?php echo $data['thn_msk']; ?> </td>
                  <td><?php echo $data['jml_masa_krj']; ?> </td>
                  <td>
