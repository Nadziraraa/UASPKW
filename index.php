...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/download.jpg');">
							 ...
							 if($row === 1 ){
								 ...
								 if($cek_password <> $password) {
									echo"<script>alert('Password Salah');</script>"; 
									 ...
									 $_SESSION['log'] = true;
									echo"<script>alert('Login Berhasil');document.location.href='admin/karyawan.php'</script>";
								 }
							 }else{
								 echo"<script>alert('email salah atau belum terdaftar');</script>";
							 }
						 }
						?>
				</form>
